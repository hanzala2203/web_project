<?php
$pageTitle = "Edit Module"; // Dynamically set based on $module['title'] if available
$headerText = "Edit Module";
$breadcrumbText = "Edit Module";
$activeMenu = "modules"; // For highlighting the active menu item in the sidebar

// The $module variable is expected to be passed from AdminController::showEditModuleForm()
// $programmes and $staffList are also expected to be passed for dropdowns

// Example: if ($module) { $pageTitle = "Edit: " . htmlspecialchars($module['title']); }
?>
    ...
    <div class="admin-container">
        ...
        <div class="admin-main">
                ...
                <div class="header-left">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><?php echo htmlspecialchars($breadcrumbText); ?><?php if (isset($module['title'])) echo " (".htmlspecialchars($module['title']).")"; ?></li>
                        </ol>
                    </nav>
                </div>
            </header>
            ...
            <main class="content-area">
                ...
                <form method="POST" action="/student-course-hub/admin/modules/<?php echo htmlspecialchars($module['id']); ?>/update">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="description" class="form-control" rows="4"><?php echo htmlspecialchars($formData['description'] ?? ''); ?></textarea>
                    </div>

                    <div class="form-group">
                        <label for="credits">Credits <span class="required">*</span></label>
                        <input type="number" name="credits" id="credits" class="form-control <?php echo isset($errors['credits']) ? 'is-invalid' : ''; ?>" 
                               value="<?php echo htmlspecialchars($formData['credits'] ?? ''); ?>" required>
                    ...
                    <div class="form-group">
                        ...
                        <select name="programme_id" id="programme_id" class="form-control <?php echo isset($errors['programme_id']) ? 'is-invalid' : ''; ?>" required>
                            ...
                            <?php foreach ($programmes as $programme): ?>
                                <option value="<?php echo $programme['id']; ?>" <?php echo (($formData['programme_id'] ?? '') == $programme['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="year_of_study" id="year_of_study" class="form-control" 
                               value="<?php echo htmlspecialchars($formData['year_of_study'] ?? ''); ?>">
                    </div>

                    <div class="form-group">
                        <label for="staff_id">Module Leader</label>
                        <select name="staff_id" id="staff_id" class="form-control <?php echo isset($errors['staff_id']) ? 'is-invalid' : ''; ?>">
                            ...
                            <?php foreach ($staffList as $staff): ?>
                                <option value="<?php echo $staff['id']; ?>" <?php echo (($formData['staff_id'] ?? '') == $staff['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-actions">
                        ...
                        <a href="/student-course-hub/admin/modules" class="btn btn-secondary">
