...
// This view expects $programmes to be passed from AdminController::listProgrammes()

// Include header - it now conditionally hides the main site header for admin pages
// include_once __DIR__ . \\'/../layouts/header.php\\'; // Removed header include
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="admin-container">
    <?php include_once __DIR__ . '/../layouts/sidebar.php'; // Include the common sidebar ?>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php foreach ($programmes as $programme): ?>
                                        <tr>
                                            <td><?php echo htmlspecialchars($programme['id']); ?></td>
                                            <td><?php echo htmlspecialchars($programme['title']); ?></td>
                                            <td><?php echo htmlspecialchars($programme['level']); ?></td>
                                            <td><?php echo htmlspecialchars(substr($programme['description'] ?? '', 0, 50) . (strlen($programme['description'] ?? '') > 50 ? '...' : '')); ?></td>
                                            <td>
