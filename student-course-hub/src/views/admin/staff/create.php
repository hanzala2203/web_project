...
$headerText = "Create Staff Member";
$breadcrumbText = "Add New Staff";
$activeMenu = "staff"; // For highlighting the active menu item in the sidebar

// $data and $errors are assumed to be passed from the controller
// $data = $data ?? []; // To retain form data on error
// $errors = $errors ?? []; // To display validation errors
?>
            ...
            <main class="content-area">
                ...
                <?php endif; ?>                <form method="POST" action="/student-course-hub/admin/staff/create">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password_confirmation" id="password_confirmation" class="form-control <?php echo isset($errors['password_confirmation']) ? 'is-invalid' : ''; ?>" required>
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary"><i class="fas fa-user-plus"></i> Create Staff Member</button>
