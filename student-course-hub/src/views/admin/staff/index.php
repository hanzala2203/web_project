<?php
// filepath: c:\xampp\htdocs\student-course-hub\src\views\admin\staff\index.php
$pageTitle = "Manage Staff";
$headerText = "Staff Members";
$breadcrumbText = "Manage Staff";
$activeMenu = "staff"; // For highlighting the active menu item in the sidebar

// Data would be passed from AdminController::adminStaffList()
        ...
        <div class="admin-main">
            <header class="admin-header-main">
                ...
                <div class="header-right">
                    <a href="/student-course-hub/admin/staff/create" class="btn btn-primary"><i class="fas fa-user-plus"></i> Add New Staff</a>
                </div>
            </header>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (empty($staffList)): ?>
                            <div class="alert alert-info">No staff members found. <a href="/student-course-hub/admin/staff/create">Click here to add one.</a></div>
                        <?php else: ?>
